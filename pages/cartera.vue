...
<script>
  ...
  import CustomersList    from "@/pages/cartera/partials/customers";
  import InvoicesList     from "@/pages/cartera/partials/invoices";
  import TableTotals      from "@/pages/cartera/partials/totals";
    ...
    export default {
          ...
          methods: {
              ...
              carteraTotalPorVendedor() {
                  Terceros.carteraTotalPorVendedor ( this.$auth.user.id_terc )
                  .then( response => {
