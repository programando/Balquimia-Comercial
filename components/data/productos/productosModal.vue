<template>
  <div>
     <button class="px-4 py-1  text-white bg-primary border border-grey-500 rounded hover:bg-secondary"
        ...
        <div class="bg-white flex rounded-lg w-1/2 relative">
            <div class="flex flex-col items-start">
                <div class="p-7 flex items-center w-full">
                    <div class="text-gray-900 font-bold text-lg">Búsqueda de productos</div>
                    <svg @click="modalClose('mymodalcentered')" class="ml-auto fill-current text-gray-700 w-5 h-5 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
                ...
                <div class="p-7 flex justify-end items-center w-full">
                    ...
                    <button type="button" @click="modalClose('mymodalcentered')" class="bg-transparent hover:bg-gray-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                        Close
                    </button>
                </div>
            </div>
